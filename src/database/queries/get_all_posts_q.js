...
exports.getAllPosts=((cb)=>{
  ...
  sql='SELECT t1.id,t2.img_profile,t2.id AS userID ,t1.post_title,t1.img_url,t1.post_content,t2.user_name FROM posts t1 inner join users t2 on t2.id=t1.user_id '
